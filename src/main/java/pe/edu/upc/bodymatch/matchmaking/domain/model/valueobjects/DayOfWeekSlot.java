package pe.edu.upc.bodymatch.matchmaking.domain.model.valueobjects;
...
@Embeddable
public record DayOfWeekSlot(DayOfWeek dayOfWeek, LocalTime startTime, LocalTime endTime) {
