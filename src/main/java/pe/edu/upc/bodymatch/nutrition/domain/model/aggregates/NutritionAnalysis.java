package pe.edu.upc.bodymatch.nutrition.domain.model.aggregates;
...
import pe.edu.upc.bodymatch.nutrition.domain.model.valueobjects.NutritionAnalysisStatus;
...
public class NutritionAnalysis extends AuditableAbstractAggregateRoot<NutritionAnalysis> {
    ...
    public BigDecimal totalCalories() {
        return totalMacros == null ? BigDecimal.ZERO : totalMacros.calories();
    }
}
