package pe.edu.upc.bodymatch.iam.infrastructure.tokens.jwt.services;
...
public class TokenServiceImpl implements BearerTokenService {
    ...
    @Value("${authorization.jwt.access.expiration.minutes:60}")
    ...
    private String buildTokenWithDefaultParameters(String email) {
        ...
        var expiration = DateUtils.addMinutes(issuedAt, accessExpirationMinutes);
