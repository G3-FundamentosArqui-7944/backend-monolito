package pe.edu.upc.bodymatch.iam.infrastructure.authorization.sfs.model;
...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(User user) {
        ...
        return new UserDetailsImpl(user.getEmail(), user.getPassword(), user.isActive(), authorities);
    }
}
